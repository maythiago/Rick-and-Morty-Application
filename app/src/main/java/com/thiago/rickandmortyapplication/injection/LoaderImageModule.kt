...
import com.thiago.rickandmortyapplication.utils.glide.OkHttpUrlLoaderCoroutines
...
//        registry.replace(GlideUrl::class.java, InputStream::class.java, OkHttpUrlLoader.Factory(okhttp))
        registry.replace(GlideUrl::class.java, InputStream::class.java, OkHttpUrlLoaderCoroutines.Factory(okhttp))
